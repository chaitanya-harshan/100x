...
const SignUp = () => {
  ...
  return (
    ...
    <div className="flex-col justify-center w-80 p-3 px-5 rounded-lg bg-white text-center">
        ...
        <InputBox label={"Email"} placeholder={"aegon@targaryen.com"} setState={setEmail}/>
        <InputBox label={"Password"} placeholder={"Commander of the Night's Watch"} setState={setPassword}/>
        <Button label={"Sign Up"} onClick={handleOnClick}/>
        <BottomWarning text={"Already have an account?"} linkText={"Login"} />
    </div>
    </div>
    </div>
  )
